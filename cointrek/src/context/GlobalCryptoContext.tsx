...
import { ContextInterface, BannerMessage, BannerMessageFunction, ContextProviderComponent } from './index';
...
export const GlobalCryptoProvider: ContextProviderComponent = ({ children }) => {
    ...
    return (
        ...
        >
            ...
            {showPopupBanner.show && <PopupBanner message={showPopupBanner.message} type={showPopupBanner.type} />}
            {serverOffline && (
                <PopupBanner message={'Unable to connect to server - please try again later.'} type='error' />
            )}
        </CryptoContext.Provider>
    );
};
