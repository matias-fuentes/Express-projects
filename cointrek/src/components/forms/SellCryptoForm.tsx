...
import { Alert, Avatar, Button, Checkbox, FormControlLabel, TextField, Typography } from '@mui/material';
import AccountBalanceWalletIcon from '@mui/icons-material/AccountBalanceWallet';
import { useTheme } from '@mui/material/styles';
import { ResponseType, useGlobalContext } from '../../context';
import { capitalizeFirstLetter, numberWithCommas } from '../../utilities/helpers';
...
export const SellCryptoForm: FC<Props> = ({ crypto, handleClose, walletQuantity }) => {
        ...
        if (quantity === 0 || Number.isNaN(quantity)) {
            ...
            try {
                ...
                handleBannerMessage(
                    ...
                    `Sold ${numberWithCommas(quantity)} ${crypto.ticker.toUpperCase()} coin${quantity > 1 ? 's' : ''}`
                );
                handleClose();
            } catch (error) {
                togglePageLoading();
        ...
        <SellCryptoFormWrapper>
            ...
            >
                ...
                <div className='checkoutDetails'>
                    ...
                    <p className='totalCalculation'>Total: ${numberWithCommas(quantity * crypto.price)}</p>
                </div>
