...
import { formatPrice, numberWithCommas, calculateAveragePurchasePrice } from '../../../utilities/helpers';
...
export const WalletRow = ({ row, cryptoInfo }: RowType) => {
    ...
    const formattedPrices = {
        ...
        averagePurchasePrice: numberWithCommas(formatPrice(calculateAveragePurchasePrice(transactions), 4)),
    };
                    ...
                    <Collapse in={open} timeout='auto' unmountOnExit>
                        <Box sx={{ margin: 1 }}>
                            <Table size='small' aria-label='purchases'>
                                ...
                                <TableBody>
                                    <TableRow>
                                        <TableCell component='th' scope='row' className='tableRowCells'>
                                    ...
                                    <TableRow>
                                        ...
                                        <TableCell>${formattedPrices.averagePurchasePrice}</TableCell>
                                    </TableRow>
                                    ...
                                    <TableRow>
                                        <TableCell sx={{ padding: '0' }}>
                                            <SellCryptoModal crypto={cryptoInfo} walletQuantity={row.quantity} />
                                        </TableCell>
                                    </TableRow>
                                </TableBody>
                            </Table>
